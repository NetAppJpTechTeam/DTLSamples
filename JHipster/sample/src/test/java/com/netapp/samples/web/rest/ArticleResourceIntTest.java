...
import static com.netapp.samples.web.rest.TestUtil.sameInstant;
...
public class ArticleResourceIntTest {
    ...
    public void createArticle() throws Exception {
        ...
        assertThat(testArticle.getDate()).isEqualTo(testArticle.getDate());
        assertThat(articleEs).isEqualToIgnoringGivenFields(testArticle, "date");
    }
